...
import sickbeard
from sickbeard.providers import (abnormal, alpharatio, archetorrent, binsearch, bitcannon, bjshare, btn, cpasbien, danishbits, ddlisland, elitetorrent, filelist,
                                 gftracker, gimmepeers, grabthebeast, hd4free, hdbits, hdspace, hdtorrents, hdtorrents_it, horriblesubs, hounddawgs, ilcorsaronero,
                                 immortalseed, iptorrents, limetorrents, magnetdl, morethantv, ncore, nebulance, newpct, norbits, nyaa, omgwtfnzbs, pretome,
                                 rarbg, scc, scenetime, seriescr, shazbat, skytorrents, speedcd, thepiratebay, tntvillage, tokyotoshokan, torrent9, torrentbytes,
                                 torrentday, torrentleech, torrentproject, torrentz, tvchaosuk, xthor, yggtorrent, zonetelechargement)

__all__ = [
    'abnormal', 'alpharatio', 'archetorrent', 'binsearch', 'bitcannon', 'bjshare', 'btn', 'cpasbien', 'danishbits', 'ddlisland',
    'elitetorrent', 'filelist', 'gftracker', 'gimmepeers', 'grabthebeast', 'hd4free', 'hdbits', 'hdspace', 'hdtorrents', 'hdtorrents_it',
